...
export const TRIGGER_MODE_TEXT = {
  [TriggerMode.Always]: { title: 'Always', desc: 'Spoj Difficulty is queried on every search' },
  [TriggerMode.Manually]: {
    title: 'Manually',
    desc: 'Spoj Difficulty is queried when you manually click a button',
  },
}
...
export const Prompt ='Here is problem:'
